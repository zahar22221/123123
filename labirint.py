...
class Player(GameSprite):
 ...
 def fire(self):
     bullet = Bullet('bulet.png', self.rect.right, self.rect.centery, 20, 25, 15)
     bullets.add(bullet)
...
w1 = GameSprite('CTEHA4.png',win_width / 2 - win_width / 3, win_height / 2, 300, 50)
w2 = GameSprite('CTEHA5.png', 370, 100, 50, 400)
...
#создаем спрайты
packman = Player('KBADRAT.png', 5, win_height - 80, 80, 80, 0, 0)
final_sprite = GameSprite('MOHCTEP.png', win_width - 85, win_height - 100, 80, 80)
 
monster1 = Enemy('FIHAL.png', win_width - 80, 100, 80, 80, 5)
monster2 = Enemy('FIHAL.png', win_width - 80, 290, 80, 80, 5)
